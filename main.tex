...
%Texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto. Texto opcional.
...
O nome desse campo se deve ao resultado clássico de Frank P. Ramsey \cite{Ra} que provou que para quaisquer inteiros positivos $t$ e $q$, existe um inteiro $n$ tal que toda $q$-coloração de arestas do grafo completo $K_n$ contém uma cópia monocromática de $K_t$.
...
Ao longo dos últimos anos, o grafo aleatório $G(n,p)$ tem sido o grafo alvo de coloração cujas propriedades Ramsey são estudadas \cite{rodl1993lower, rodl1995threshold}, especialmente quanto a funções limiares. 
