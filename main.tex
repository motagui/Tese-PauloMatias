...
%%%%xxxx Por último, o número de size-Ramsey de um grafo $H$ é o menor
%%%%inteiro $m$ para o qual existe um grafo $G$ com $m$ arestas tal
%%%%que em toda 2-coloração de $E(G)$, há uma cópia monocromática de
%%%%$H$. Na variante do número de size-Ramsey para grafos orientados,
%%%%verificamos que inverter a orientação de uma única aresta de uma
%%%%estrela orientada de $m$ arestas torna esse parâmetro quadrático.
\ 
\\
...
\chapter{Um problema do tipo anti-Ramsey}\label{sec:anti}
